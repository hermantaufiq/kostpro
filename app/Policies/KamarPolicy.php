...
class KamarPolicy
{
    ...
    {
        return $user->hasPermissionTo('view_kamar');
    }
    ...
    {
        return $user->hasPermissionTo('create_kamar');
    }
    ...
    {
        return $user->hasPermissionTo('update_kamar');
    }
    ...
    {
        return $user->hasPermissionTo('delete_kamar');
    }
