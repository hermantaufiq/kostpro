    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-soft border border-slate-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8">
                ...
                <div class="mt-8 pt-6 border-t border-slate-100 flex gap-3 justify-end">
                    <a href="{{ route('invoice.print', $tagihan->id) }}" target="_blank" class="px-4 py-2 border border-slate-200 text-slate-700 rounded-xl hover:bg-slate-50 transition text-sm font-medium flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"></path></svg>
                        Print HTML
                    </a>
                    <a href="{{ route('invoice.download', $tagihan->id) }}" class="px-4 py-2 bg-indigo-50 text-indigo-700 border border-indigo-100 rounded-xl hover:bg-indigo-100 transition text-sm font-bold flex items-center gap-2">
